...
namespace PROJECTTRACKING.Controllers
{
    public class PersonelProjelerisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonelProjeId,ProjeBaslik,ProjeAciklama,OlusturmaTarihi,OncelikDurumu,TamamlanmaOrani,TamamlanmaTarihi,TamamlanmaDurumu")] PersonelProjeleri personelProjeleri)
        {
