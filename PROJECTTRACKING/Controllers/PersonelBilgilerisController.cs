...
namespace PROJECTTRACKING.Controllers
{
    public class PersonelBilgilerisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonelBilgileriId,Eposta,Sifre,Yetki,AdSoyad,TCNO,Departman,Gorev,PozisyonAciklama,TelNo,Adres,MedeniHal,YakinBilgi,YakinTC,YakinAdSoyad,YakinTel,DogumTarihi,İseGirisTarihi")] PersonelBilgileri personelBilgileri)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonelBilgileriId,Eposta,Sifre,Yetki,AdSoyad,TCNO,Departman,Gorev,PozisyonAciklama,TelNo,Adres,MedeniHal,YakinBilgi,YakinTC,YakinAdSoyad,YakinTel,DogumTarihi,İseGirisTarihi")] PersonelBilgileri personelBilgileri)
        {
            if (ModelState.IsValid)
            {
